<div class='profile'>
	...
	<form method='POST' class='profileForm' enctype='multipart/form-data' action='/users/p_editprofile'>
		...
		Web Site <br> <input type='text' name='site' value = '<?=$user->site?>' size=50><br>
